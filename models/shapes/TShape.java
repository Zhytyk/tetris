...
import tetris.models.shapes.interfaces.TShapeRotatable;

public class TShape extends CompositeShape implements TShapeRotatable {
    ...
    public boolean isVerticalEdge(boolean[][] cells) {
        return isVerticalEdge(cells, rotateIterator % 2 == 0 ? 1 : 2);
    }

    @Override
    public boolean isHorizontalRightEdge(boolean[][] cells) {
        return isHorizontalRightEdge(cells, rotateIterator % 2 == 0 ? 2 : 1);
    }

    @Override
    public boolean isHorizontalLeftEdge(boolean[][] cells) {
        return isHorizontalLeftEdge(cells, rotateIterator % 2 == 0 ? 2 : 1);
    }
